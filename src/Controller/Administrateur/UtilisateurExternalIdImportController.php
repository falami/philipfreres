...
use App\Form\Administrateur\UtilisateurExternalIdImportType;
use App\Security\Permission\TenantPermission;
use App\Service\Import\UtilisateurExternalIdExcelImporter;
...
final class UtilisateurExternalIdImportController extends AbstractController
{
  ...
  {
    $form = $this->createForm(UtilisateurExternalIdImportType::class);
    ...
    if ($form->isSubmitted() && $form->isValid()) {
      ...
      if (!$file) {
        ...
        return $this->redirectToRoute('app_administrateur_utilisateur_external_id_import', ['entite' => $entite->getId()]);
      }
    ...
    return $this->render('administrateur/utilisateur_external_id/import.html.twig', [
      'entite' => $entite,
      'form' => $form,
      'result' => $result,
    ]);
  ...
  {
    $path = $this->getParameter('kernel.project_dir') . '/public/exemples/exemple-import-utilisateur-external-ids.csv';
    ...
    $response->setContentDisposition(
      ...
      'exemple-import-utilisateur-external-ids.csv'
    );
