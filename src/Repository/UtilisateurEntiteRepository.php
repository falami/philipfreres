...
class UtilisateurEntiteRepository extends ServiceEntityRepository
{
    ...
    public function isTenantAdmin(Utilisateur $user): bool
    {
        ...
        $qb = $this->createQueryBuilder('ue')
            ...
            ->andWhere('JSON_CONTAINS(ue.roles, :admin) = 1')
            ->setParameter('u', $user)
    ...
    {
        // seul le ADMIN de l'entité peut définir ADMIN
        return $this->hasRoleInEntite($actor, $entite, UtilisateurEntite::TENANT_ADMIN);
    }
}
